...
var UI = (function () {
  ...
  function pageHeader(opts) {
    ...
    var sub = opts.subtitle
      ...
      : '';
    return '<div style="margin-bottom:' + (opts.mb || '28px') + '">'
  ...
  function pageHeaderEditable(opts) {
    ...
    var sub = opts.subtitle
      ? '<div style="font-size:13px;color:var(--muted);margin-top:5px;line-height:1.4">' + esc(opts.subtitle) + '</div>' : '';
    return '<div style="margin-bottom:' + (opts.mb || '28px') + '">' + crumb + titleRow + sub + '</div>';
  }
  ...
  return {
    ...
    // Navigation
    pills: pills, yearNav: yearNav, quarterPills: quarterPills,
    // Overlays
