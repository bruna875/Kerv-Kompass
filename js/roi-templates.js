...
function rnxRoiStrategicBenefitsHtml() {
  return '<div class="rnx-rt-wrap">'
    ...
    +           '<div class="rnx-tip">'
    +             '<strong>Tier 1: Game Changer (10%)</strong> — Massive projects that transform the business model (e.g., full migration to SaaS).<br><br>'
    +             '<strong>Tier 2: Core Accelerator (5%)</strong> — High-impact initiatives focusing on key areas (e.g., core infrastructure automation).<br><br>'
    +             '<strong>Tier 3: Capability Builder (2%)</strong> — Unlocking new functionalities or technologies (e.g., integrating a new AI module).<br><br>'
    +             '<strong>Tier 4: Tactical Enabler (1%)</strong> — Small strategic enablers (e.g., advanced analytics tools for a specific team).'
    +           '</div>'
    +         '</div>'
